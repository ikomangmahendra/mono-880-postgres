 ...
 */
type FormValueOf<T extends INotification | NewNotification> = Omit<T, 'startDate' | 'endDate'> & {
...
type NotificationFormDefaults = Pick<NewNotification, 'id' | 'startDate' | 'endDate'>;

type NotificationFormGroupContent = {
  id: FormControl<NotificationFormRawValue['id'] | NewNotification['id']>;
  startDate: FormControl<NotificationFormRawValue['startDate']>;
  endDate: FormControl<NotificationFormRawValue['endDate']>;
};
...
export class NotificationFormService {
  createNotificationFormGroup(notification: NotificationFormGroupInput = { id: null }): NotificationFormGroup {
    ...
    return new FormGroup<NotificationFormGroupContent>({
      ...
      endDate: new FormControl(notificationRawValue.endDate),
    });
  }
  ...
  private convertNotificationRawValueToNotification(
    ...
    return {
      ...rawNotification,
      startDate: dayjs(rawNotification.startDate, DATE_TIME_FORMAT),
      endDate: dayjs(rawNotification.endDate, DATE_TIME_FORMAT),
    };
  }
  ...
  private convertNotificationToNotificationRawValue(
    ...
    return {
      ...notification,
      startDate: notification.startDate ? notification.startDate.format(DATE_TIME_FORMAT) : undefined,
      endDate: notification.endDate ? notification.endDate.format(DATE_TIME_FORMAT) : undefined,
    };
  }
}
